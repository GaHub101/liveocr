...
5. Tippe auf **„Scannen"** – das Kamerabild wird an Gemini 3.5 Flash gesendet, das die REF-Nummer erkennt
...
| **`src/ocr.js`** | Sendet das Kamerabild (50 % skaliert, JPEG q0.7) per POST an den Apps Script Webhook; Gemini 3.5 Flash erkennt die REF-Nummer serverseitig |
