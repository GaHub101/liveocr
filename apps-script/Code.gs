...
function handleBootstrap() {
  ...
  // Hersteller (Spalte C, unique), Kategorien (Spalte D, unique) und
  // REF→Hersteller-Paare (F→C) aus "Bestellungen" für Dropdown-Vorschläge
  // und die Hersteller-Vorauswahl anhand ähnlicher REFs
  var herstellerSeen = {};
  var hersteller = [];
  var kategorienSeen = {};
  var kategorien = [];
